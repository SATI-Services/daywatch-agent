...
/**
 * Per-connection frame processing (daywatch-mcp/docs/agent-protocol.md §4). Feeds raw bytes
...
final class ConnectionHandler
{
     ...
     * same shape as the ack (daywatch-mcp/docs/agent-protocol.md §4). Guarded: a responder or
