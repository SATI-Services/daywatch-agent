...
/**
 * O(1) ingest bookkeeping for the daywatch:agent daemon (agent protocol
...
final class DaemonStats
{
    ...
    /**
     * The STATS reply payload — field names are contract (agent protocol §4).
     *
    ...
    /** One supervisor-visible stdout line (agent protocol §5). */
